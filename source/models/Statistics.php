...
class Statistics
{
  ...
  public function getGeneralStatistics($id_schoolyear, $semester)
  {
    ...
    $query = "SELECT tbl_attendance.id_user, id_student, fullname, tbl_team.name AS team, tbl_schoolyear.schoolyear,
    ...
    FROM tbl_attendance, tbl_user, tbl_team, tbl_schoolyear
    WHERE tbl_attendance.id_schoolyear = '$id_schoolyear' AND semester = '$semester' AND tbl_attendance.id_user = tbl_user.id_user 
    AND (tbl_user.id_team = tbl_team.id_team OR tbl_user.id_team IS NULL) AND tbl_attendance.id_schoolyear = tbl_schoolyear.id_schoolyear
    GROUP BY tbl_attendance.id_user";
  ...
  public function getDetailedStatistics($id_schoolyear, $semester)
  {
    ...
    $query = "SELECT id_attendance, tbl_user.id_user, tbl_user.id_student, tbl_user.fullname , tbl_team.name AS team, schoolyear, semester, shift, date                                
    FROM tbl_attendance, tbl_user, tbl_team, tbl_schoolyear
    WHERE tbl_attendance.id_schoolyear = '$id_schoolyear' AND semester = '$semester' 
    AND tbl_attendance.id_user = tbl_user.id_user  AND (tbl_user.id_team = tbl_team.id_team OR tbl_user.id_team IS NULL) 
    AND tbl_attendance.id_schoolyear = tbl_schoolyear.id_schoolyear
    ORDER BY date DESC";
